...
public abstract class ExpenseManager implements Serializable {
     ...
     */
    public int updateAccountBalance(String accountNo, int day, int month, int year, ExpenseType expenseType,
        ...
        if (!amount.isEmpty()) {
            ...
            int rowId = transactionsHolder.logTransaction(transactionDate, accountNo, expenseType, amountVal);
